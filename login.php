	...
	<div class="items-container">
		...
		<form action="<?php $_SERVER['PHP_SELF']?>" method="POST" id="login-form">
			<div class="input-field" id="field-email">
				...
				<input type="email" id="email" name="email" value="<?=sanitize_data($email)?>" placeholder="Enter your email" autocomplete="off">
			</div>
			<div class="input-field" id="field-password">
				<span class="icon-input"><i class="fa-solid fa-lock"></i></span>
				<input type="password" id="password" name="password" value="<?=sanitize_data($password)?>" placeholder="Enter password" autocomplete="off">
